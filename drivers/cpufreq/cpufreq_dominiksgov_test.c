...
{	struct task_struct* task, *group_leader_task, *task_buffer;
    ...
    switch (cmd){
        ...
        case IOCTL_CMD_NEW_FRAME:
            ...
            // TODO: test
            //get_task_comm(buf, group_leader_task);
            //KERNEL_ERROR_MSG("GOV|LEADER: pid=%i, comm=%s",group_leader_task->pid, buf);
            ...
            // TODO: comment in and test
            // TODO: add timestamp for plotting? Or from log?
